...
begin
  ...
  FListagem.cdsAtividade.FieldByName('ID').Visible:= false;
  FListagem.cdsAtividade.FieldByName('ID_TIPOATIVIDADE').Visible:= false;

  FListagem.cdsAtividade.IndexFieldNames:= 'DESCRICAO';

  dbgAtividade.Columns[0].Width:=  300;
  dbgAtividade.Columns[1].Width:=  500;
  dbgAtividade.Columns[2].Width:=  350;
